...
Right now we are teaching 🟢 [Bostrom](https://bostrom.network) to reason — a bootloader that will grow into 🔵 [Cyber](https://cyber.page). We are creating 👽 [Trident](https://trident.pink) — a weapon to supercharge it. And the army of 🤖 [Cyb](https://cyb.ai) — the superagents to fight.
